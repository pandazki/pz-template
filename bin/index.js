...
program
  ...
  .requiredOption("-l, --location <template location>", "Template location. /path/to/your/local/template/folder or git@your.domain:your.repo.git|hash")
  .option(
  ...
  .action(async (options) => {
    ...
    try {
      await loader.copyTo(outputTmpAbs);
    } catch (e) {
      console.error(e);
